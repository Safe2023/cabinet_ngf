    ...
    <div class="container-fluid bg-light text-white pt-2 pb-3 d-none d-lg-flex">
        <div class="container pb-2">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <img src="<?php echo e(asset('img/logo.png')); ?>" class="logo-img" alt="Logo 1">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="w-100">
                                <div class="input-group">
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('newsletter')); ?>" method="post" class="d-flex">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\HP\Desktop\Ngf\cabinet\resources\views/layouts/header.blade.php ENDPATH**/ ?>